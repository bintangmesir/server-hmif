...
func BukuRoute(app *fiber.App){    
    ...
    v1.Get("/buku",middlewares.RoleMiddleware([]string{"kadep_prhp", "staff_prhp"}), buku.GetBuku)
    v1.Get("/buku/:id", middlewares.RoleMiddleware([]string{"kadep_prhp", "staff_prhp"}), buku.GetByIdBuku)
